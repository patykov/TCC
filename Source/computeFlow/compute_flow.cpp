...
std::string vid_path = "E:\TCC\Datasets\UCF-101";

std::string out_path	= "/E:\TCC\Datasets\UCF-101_opticalFlow";
std::string out_path_jpeg	= "/E:\TCC\Datasets\UCF-101_frames";
