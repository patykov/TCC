...
from cntk.layers import (Activation, AveragePooling, BatchNormalization, Convolution, Convolution2D,
                         Dense, Dropout, default_options, For, MaxPooling, Sequential)
from cntk.ops import relu


def from_scratch(model_name, input_var, num_classes, dropout=0.9):
