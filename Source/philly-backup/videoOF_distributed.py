import argparse
from cntk import data_parallel_distributed_learner, Trainer, UnitType
...
class VideoReader(object):
    ...
    def next_minibatch(self, batch_size):
        ...
        self.v_dataDir = zipfile.ZipFile(os.path.join(self.datadir, 'v.zip'), 'r')
        self.u_dataDir = zipfile.ZipFile(os.path.join(self.datadir, 'u.zip'), 'r')
        ...
        self.v_dataDir.close()
        self.u_dataDir.close()
    ...
    def _train_stack_transform(self, frameStack):
        video_array = []
        img = Image.open(self.v_dataDir.open(frameStack[0]))
        width  = img.size[0]
        height = img.size[1]
...
if __name__ == '__main__':
    ...
    train_reader = VideoReader(train_map_file, dataDir, image_width, image_height, stack_length, 
    ...
    test_reader = VideoReader(test_map_file, dataDir, image_width, image_height, stack_length, 
