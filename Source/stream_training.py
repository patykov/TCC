...
def stream_train(stream_type, map_files, output_dir, log_file,
                 model_name, base_model, distributed=True):
    # Model dimensions
    num_channels = 3
    num_classes = 101
...
if __name__ == '__main__':
    ...
    parser.add_argument('-stream_type',
                        ...
                        required=True)
    parser.add_argument('-distrib_off',
                        help="Turn off distributed training",
                        action='store_true',
                        required=False)
